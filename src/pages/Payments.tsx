                ...
                <Dialog open={depositOpen} onOpenChange={setDepositOpen}>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>Add funds to your SkyBook wallet</DialogDescription>
                    </DialogHeader>
                ...
                <Dialog open={withdrawOpen} onOpenChange={setWithdrawOpen}>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>Transfer funds from your SkyBook wallet</DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                      <div className="grid gap-2">
